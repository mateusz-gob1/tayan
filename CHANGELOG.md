...
- Link preview tags (Open Graph), a page description and a theme colour, with the 1280x640 logo image, so a link to the game shows a proper card in chats and social networks
