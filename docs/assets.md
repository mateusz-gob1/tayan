...
- 56x80 px cards, AAP-64 palette (the pack also has a high-contrast variant with orange diamonds and blue clubs, which the game does not use: it plays with black and red cards only)
- Used files: 52 faces and 4 backs in `apps/web/src/assets/cards/`, renamed by `apps/web/scripts/import-cards.mjs` (`<rank><suit>.png`, ranks 2 to 14 with 14 = ace, suits C/D/H/S).
